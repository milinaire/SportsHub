  ...
  static displayName = Header.name;
    ...
    server = {
        User: {
            ...
            name: "Ivan",
            surname:"Baloh",
            image_url: "https://widgetwhats.com/app/uploads/2019/11/free-profile-photo-whatsapp-4.png",
            user_actions: ["Action","Another action","Something","Another something"]
        },
        Languages: {
            current_lang: ["En",0],
       ...
       <>
           <header className="sticky-top" >
               ...
               <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
                   ...
                   <div className="item1">
                       <Link to="/" className="brand-card"> <Row className="brand-text"><p>Sports Hub</p></Row></Link>
                   </div>
                   <div className="item2">
                       <Form className="search-card" inline>
                           <Row className="pl-lg-5">
                               ...
                               <FormControl type="text" placeholder="Search By" className="search-card from-width-fix" />
                           </Row>
                       </Form>
                   </div>
                   <div className="item3">
                   ...
                   <div className="item4">
                       ...
                       <Row className="profile-section-row">
                           {this.state.User.login === true ? 
                               (
                               <>
                                   <Image className="profile-section avatar-img" src={this.state.User.image_url}/>
                                   <NavDropdown className="dropdown-header "
                                                title={this.state.User.name +" "+ this.state.User.surname}
                                                id="dropdownMenu1">
                                       {this.state.User.user_actions.map((action,key) =>
                                           (
                                               <NavDropdown.Item href={"#" + action + key}>{action}</NavDropdown.Item>
                                           )
                                       )}
                                   </NavDropdown>
                               </>
                               ...
                               (
                                   <div className="pt-2">
                                       <Button className="login-button btn-danger mr-2">Sign up</Button>
                                       <Button className="signin-button btn-danger" >Log in</Button>
                                   </div>
                               )
                           }
                           
                           <NavDropdown className="ml-lg-2 dropdown-header"
