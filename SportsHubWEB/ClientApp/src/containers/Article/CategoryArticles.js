...
export class CategoryArticles extends Component {
  ...
  render() {
    ...
    for (let i = 0; i < this.state.Articles.length; i++) {
      ...
      list.push(
          <Link to={`${this.props.match.params.category}/~/~/${this.state.Articles[i].Url}`}><div className={"article"} style={{display:"flex", margin:"15px"}}>
            <img src={this.state.Articles[i].Image} style={{width:"40%", height:"240px", padding:"10px"}} alt={this.state.Articles[i].Alt}/>
            <div>
